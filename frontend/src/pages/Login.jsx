    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="card p-8">
          ...
          <p className="text-slate-400 text-sm mb-6">Log in to continue building.</p>
          ...
          <div className="mt-6 text-center text-sm text-slate-400">
            New here? <Link to="/register" className="text-purple-300 hover:text-purple-200">Create an account</Link>
          </div>
        </div>
      </div>
    </div>
